...
public class SimpleHashtable<K, V> implements Iterable<SimpleHashtable.TableEntry<K,V>>{
	...
	/**
	 * Kontorlna varijabla za iskorištenost slotova u tablici
	 */
	private static final double limitUsage = 0.75;
	/**
	...
	public void checkUsage() {
		if(usedSlots / (numberOfSlots * 1.0) >= limitUsage) {
			reallocate();
		}
	}
	...
	/**
	 *Metoda "tvornica" koja proizvodi iteratore koji se mogu
	 *koristiti za obilazak po svim parovima koji su trenutno pohranjeni u tablici.
	 */
