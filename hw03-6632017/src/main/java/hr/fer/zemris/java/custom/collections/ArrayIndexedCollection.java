...
public class ArrayIndexedCollection implements List {
	...
	private static class ArrayElementsGetter implements ElementsGetter {
		...
		private ArrayIndexedCollection parent;

		
			public ArrayElementsGetter(ArrayIndexedCollection parent) {
	...
	public ElementsGetter createElementsGetter() {
		...
		ElementsGetter getter = new ArrayElementsGetter(this);
	...
	/**
	 * Constructor
	 * Set capacity of collection to default capacity
	 */
